...
flags.DEFINE_float('prob', 0.5, 'prob of being picked for less than 0.05 angles')


driving_log_dir = []
# driving_log_dir.append("./afterBridge2")
# driving_log_dir.append("./afterBridge3")
# driving_log_dir.append("./Peng_data_track1_recovery")
# driving_log_dir.append("./Peng_data_track1_reverse")
